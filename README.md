...
This project is about writing our own HTTP server. We will be able to test it with an actual browser. HTTP is one of the most widely used protocols on the internet. Understanding its intricacies will be useful, even if we won’t be working on a website.

# Starting Documentation

[Pierre Riraud HTTP/Réseaux/Sécurité FR](https://www.pierre-giraud.com/http-reseau-securite-cours/)
